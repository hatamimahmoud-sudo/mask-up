...
- **Masks:** thirty-three of them, with a Halloween set, from a surgical mask to a balaclava, clay and sheet skin masks, a skull, a beard and bunny ears, plus a custom one lifted straight off a photo of someone wearing a mask you like, or drawn by Claude from a sentence you type (bring your own API key). Painted as textures onto the 898-triangle face mesh in WebGL and re-lit from the video, so they wrap the nose and cheeks, move with the mouth and sit in the same light as the face.
